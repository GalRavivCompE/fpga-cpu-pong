...
- Data memory is byte addressed and little-endian. An aligned 32-bit word at address `A` consists of bytes at `A`, `A+1`, `A+2`, and `A+3`, with the least significant byte at `A`.
